...
| **III. Identity, Trust & Supply Chain**      | MCP-01 to MCP-03, MCP-09 , MCP-16, MCP-18, MCP-26 to MCP-31 | MCP has no mandatory cryptographic server identity or content integrity.     | Rug Pull / Dynamic Behavior Change, Supply Chain Compromise, Shadow MCP Servers                |
...
If you find our paper&tool interesting and useful, please feel free to leave a star⭐️ and cite our paper:
