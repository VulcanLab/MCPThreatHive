...
# MCP Threat ID to OWASP Agentic Top 10 mapping
...
# OWASP Agentic Top 10 keyword patterns for classification
OWASP_AGENTIC_KEYWORDS = {
    "ASI01": ["agent hijacking", "behavior hijacking", "decision manipulation", "agent control", "malicious actor", "agent takeover", "goal hijacking"],
    "ASI02": ["prompt injection", "prompt manipulation", "instruction manipulation", "hidden prompt", "indirect injection", "jailbreak"],
    "ASI03": ["tool misuse", "tool exploitation", "api abuse", "function abuse", "tool manipulation", "unintended tool use", "tool hijack"],
    "ASI04": ["identity abuse", "privilege abuse", "credential theft", "impersonation", "privilege escalation", "unauthorized access", "token theft"],
    "ASI05": ["inadequate guardrails", "sandbox escape", "missing boundaries", "insufficient isolation", "container escape", "breakout"],
    "ASI06": ["sensitive disclosure", "data leakage", "confidential leak", "pii exposure", "information exfiltration", "privacy violation"],
    "ASI07": ["data poisoning", "data manipulation", "corrupted data", "knowledge poisoning", "memory poisoning", "context poisoning"],
    "ASI08": ["resource exhaustion", "denial of service", "dos attack", "cost attack", "denial of wallet", "excessive resource"],
    "ASI09": ["supply chain", "insecure integration", "third-party vulnerability", "upstream attack", "dependency attack", "mcp exploit"],
    "ASI10": ["over-reliance", "misplaced trust", "blind faith", "human-in-the-loop bypass", "oversight failure", "approval fatigue"],
}
